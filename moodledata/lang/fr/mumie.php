...
/**
 * Strings for component 'mumie', language 'fr', version '4.0'.
 *
 * @package     mumie
 * @category    string
...
$string['mumie:grantduedateextension'] = 'Accorder une prolongation de la date d\'achèvement pour des étudiants individuels';
