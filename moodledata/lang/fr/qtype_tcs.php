...
/**
 * Strings for component 'qtype_tcs', language 'fr', version '4.0'.
 *
 * @package     qtype_tcs
 * @category    string
...
$string['pluginname'] = 'Test de concordance de script';
...
$string['pluginnameadding'] = 'Ajout d\'une question TCS';
$string['pluginnameediting'] = 'Edition d\'une question TCS';
$string['pluginnamesummary'] = 'Le test de concordance de script (TCS) est une méthode d\'évaluation du raisonnement professionnel en contexte d\'incertitude à l\'aide de situations simulées de la vie professionnelle ou de la vie courante.';
