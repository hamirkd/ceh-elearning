...
/**
 * Strings for component 'offlinequiz', language 'fr', version '4.0'.
 *
 * @package     offlinequiz
 * @category    string
...
\\begin{center}{Examen écrit {$a->date}}\\end{center}
%%%
\\def\\Group{{$a->groupname}}
\\begin{center}{\\Large Groupe \\Group}\\end{center}

{\\bf Nom :}\\\\
{\\bf Numéro d\'immatriculation :}\\\\
{\\bf Signature :}\\
