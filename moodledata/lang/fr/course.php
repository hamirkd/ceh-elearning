...
/**
 * Strings for component 'course', language 'fr', version '4.0'.
 *
 * @package     course
 * @category    string
...
$string['downloadcourseconfirmation'] = 'Vous allez télécharger un fichier ZIP des contenus du cours (à l\'exclusion des éléments ne pouvant pas être téléchargés et des fichiers sont la taille dépasse {$a}).';
