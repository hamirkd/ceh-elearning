...
/**
 * Strings for component 'block_quickmail', language 'fr', version '4.0'.
 *
...
$string['addionalemail'] = 'Autoriser les messages vers des adresses électroniques externes';
$string['addionalemail_desc'] = 'Si cette option est activée, les messages de Courriel sont aussi envoyés aux adresses électroniques externes que l\'utilisateur a saisi dans le formulaire.';
...
$string['back_to_previous'] = 'Retour à la page précédente';
...
$string['download_auth_only'] = 'Utilisateurs autorisés uniquement';
$string['download_open'] = 'Ouvrir les téléchargements';
