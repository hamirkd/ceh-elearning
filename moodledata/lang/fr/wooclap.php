...
/**
 * Strings for component 'wooclap', language 'fr', version '4.0'.
 *
 * @package     wooclap
 * @category    string
...
$string['consent-screen:explanation'] = 'Pour que certaines options fonctionnent, comme l\'envoi d\'un rapport personnalisé à la fin d\'une session, Wooclap vous demande votre adresse de courriel. Elle ne sera jamais utilisé à des fins de marketing. Cliquez sur « J\'accepte » pour donner votre adresses de courriel à Wooclap, ou sur « Je n\'accepte pas » pour continuer sans les fonctions avancées.';
$string['customcompletion'] = 'Etat d\'achèvement mis à jour uniquement par Wooclap';
$string['customcompletiongroup'] = 'Wooclap achèvement personnalisée';
...
$string['error-invalidjoinurl'] = 'URL jointe non valide';
...
$string['gradeupdatefailed'] = 'La mise à jour a échoué';
$string['gradeupdateok'] = 'Mis à jour avec succès';
...
$string['modulenamepluralformatted'] = 'Liste des activités de Wooclap';
