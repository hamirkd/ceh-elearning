...
/**
 * Strings for component 'h5p', language 'fr', version '4.0'.
 *
 * @package     h5p
 * @category    string
...
$string['librariesmanagerdescription'] = '<p>H5P permet aux utilisateurs de créer des contenus interactifs en fournissant divers types de contenus.</p><p>Pour s\'assurer que seuls des contenus H5P fiables sont utilisés sur votre site, vous devez <i>soit</i></p><ul><li>déposer des types de contenus depuis h5p.org, <i>soit</i></li><li>activer la tâche programmée « Télécharger depuis h5p.org les types de contenus H5P disponibles ».</li></ul><p>Remarque : les utilisateurs ne pourront utiliser que les types de contenu H5P installés sur votre site.</p>';
