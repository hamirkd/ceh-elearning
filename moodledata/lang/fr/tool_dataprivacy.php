...
/**
 * Strings for component 'tool_dataprivacy', language 'fr', version '4.0'.
 *
...
$string['errorcontactdpodisabled'] = 'Le contact avec le délégué à la protection des données est désactivé';
