...
/**
 * Strings for component 'admin', language 'fr', version '4.0'.
 *
 * @package     admin
 * @category    string
...
$string['pathtopdftoppm'] = 'Chemin d\'accès à <i>pdftoppm</i>';
$string['pathtopdftoppm_help'] = 'Chemin d\'accès du programme « pdftoppm », un programme qui convertit des pages PDF en PNG au moins aussi vite que le fait « gs » (Ghostscript), mais surtout lors de la conversion de longs documents. Si l\'exécutable « pdftoppm » est présent, il sera utilisé au lieu de « gs ». Sur la plupart des serveurs Linux, le chemin « /usr/bin/pdftoppm » peut être conservé. S\'il n\'est pas présent, installer les poppler-utils ou le paquetage poppler, selon la distribution Linux. Sous Windows, l\'exécutable est fourni par Cygwin. Voir le <a href="https://poppler.freedesktop.org/" target="_blank">Poppler project</a> pour plus de détails.';
