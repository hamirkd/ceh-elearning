...
/**
 * Strings for component 'auth_saml2', language 'fr', version '4.0'.
 *
 * @package     auth_saml2
 * @category    string
...
$string['allowed_groups'] = 'Groupes autorisés';
$string['allowed_groups_help'] = 'Liste de groupes séparés par des virgules. L\'utilisateur sera autorisé à se connecter si l\'un des groupes est contenu dans l\'attribut Groups. Les groupes restreints seront tester en premier.';
...
$string['groupattr'] = 'Attribut de groupes';
$string['groupattr_help'] = 'Attribut qui contient un ensemble de groupes d\'utilisateurs';
...
$string['restricted_groups'] = 'Groupes restreints';
$string['restricted_groups_help'] = 'Liste de groupes séparés par des virgules. L\'utilisateur ne sera pas autorisé à se connecter si l\'un des groupes contient l\'attribut Groups.';
