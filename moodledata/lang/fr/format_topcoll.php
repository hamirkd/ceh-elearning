...
/**
 * Strings for component 'format_topcoll', language 'fr', version '4.0'.
 *
...
$string['notcontributed'] = 'Pas de participation';
$string['notsubmitted'] = 'Pas rendu';
