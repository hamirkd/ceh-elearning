...
/**
 * Strings for component 'tool_moodlenet', language 'fr', version '4.0'.
 *
...
$string['aria:enterprofile'] = 'Saisir votre URL de profil MoodleNet';
...
$string['forminfo'] = 'Votre profil MoodleNet sera enregistré automatiquement dans votre profil sur ce site.';
...
$string['inputhelp'] = 'Ou, si vous avez déjà un compte MoodleNet, saisissez votre profil MoodleNet :';
$string['instancedescription'] = 'MoodleNet eest une plateforme de média social ouverte pour enseignants et formateurs, qui met l\'accent sur la curation collaborative de collections de ressources ouvertes.';
$string['instanceplaceholder'] = '@votreprofil@moodle.net';
...
$string['profilevalidationerror'] = 'Un problème est survenu lors de la validation de votre profil.';
$string['profilevalidationfail'] = 'Veuillez saisir un profil MoodleNet valide';
