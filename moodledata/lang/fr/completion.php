...
/**
 * Strings for component 'completion', language 'fr', version '4.0'.
 *
 * @package     completion
 * @category    string
...
$string['showcompletionconditions'] = 'Afficher les conditions d\'achèvement';
$string['showcompletionconditions_help'] = 'Les conditions d\'achèvement de l\'activité sont affichées dans la liste des activités sur la page de cours.';
