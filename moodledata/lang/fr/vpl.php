...
/**
 * Strings for component 'vpl', language 'fr', version '4.0'.
 *
 * @package     vpl
 * @category    string
...
$string['always_use_ws'] = 'Toujours utilisé le protocole websocket non chiffré (ws)';
$string['always_use_wss'] = 'Toujours utilisé le protocole websocket chiffré (wss)';
...
$string['check_jail_servers_help'] = '<p>Cette page contrôle et affiche l\'état des serveurs d\'exécution
...
$string['maxfilesexceeded'] = 'Nombre maximum de fichiers dépassé';
...
$string['optionsnotsaved'] = 'Les options n\'ont pas été sauvegardées';
$string['optionssaved'] = 'Les options ont été sauvegardées';
...
$string['requiredpassword'] = 'Un mot de passe es requis';
...
$string['startdate'] = 'Disponible depuis';
...
$string['submittedby'] = 'Déposé par {$a}';
