...
/**
 * Strings for component 'tool_mobile', language 'fr', version '4.0'.
 *
 * @package     tool_mobile
 * @category    string
...
$string['qrcodetype_desc'] = 'Un code QR à lire par les utilisateurs de l\'app mobile peut être fourni, soit pour remplir automatiquement l\'URL du site, soit, dans le cas où le site est en HTTPS, ou pour connecter automatiquement l\'utilisateur, sans qu\'il ait besoin de saisir son nom et son mot de passe.';
...
$string['subscriptionfeaturenotapplied'] = 'Cette fonctionnalité est configurée sur votre site, mais n\'est pas inclue dans votre forfait pour l\'app Moodle. Le réglage est donc sans effet.';
