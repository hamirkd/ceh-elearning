...
/**
 * Strings for component 'scheduler', language 'fr', version '4.0'.
 *
 * @package     scheduler
 * @category    string
...
$string['on'] = 'le';
$string['oneappointmentonly'] = 'Un seul rendez-vous par étudiant';
$string['oneatatime'] = 'Un rendez-vous à la fois par étudiant';
...
$string['reuse'] = 'Réutiliser ce créneau';
...
$string['reuseguardtime'] = 'Délai de garde du créneau';
